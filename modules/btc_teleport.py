...
ORACLE_VALIDATOR_ENGINE_CONSOLE_PATH={self.ton.validatorConsole.app_path}
ORACLE_SERVER_PUBLIC_KEY_PATH={self.ton.validatorConsole.pub_key_path}
ORACLE_CLIENT_PRIVATE_KEY_PATH={self.ton.validatorConsole.priv_key_path}
