...
subprocess.run(['tar', '-xzf', name, '-C', tmp_dir])

subprocess.run(['cp', '-rf', f'{tmp_dir}/db/keyring', '/var/ton-work/db/'])
subprocess.run(['chown', '-R', 'validator:validator', '/var/ton-work/db/keyring'])
