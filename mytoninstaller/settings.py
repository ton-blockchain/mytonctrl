...
def FirstNodeSettings(local):
	...
	if DownloadDump(local) is False:
...
def DownloadDump(local):
    ...
    dump_cache_dir = GetDumpCacheDir(dump_dir)
...
def GetDumpCacheDir(dump_dir):
    return os.getenv("DUMP_CACHE_DIR", "/var/ton-work/dump-cache") or dump_dir
#end define
